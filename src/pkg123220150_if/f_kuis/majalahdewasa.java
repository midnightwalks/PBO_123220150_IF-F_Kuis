...
import Perhitungan.hitungmajalahdewasa;
...
public class majalahdewasa extends JFrame implements ActionListener{
    JLabel judul = new JLabel("Halaman Pembelian");
    JLabel tagkategori = new JLabel("Kategori      Majalah Dewasa");
    JLabel tagharga = new JLabel   ("Harga         Rp 26.900 /pcs");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == tombolbeli){
           try {
               ...
               // membuat objek
               hitungmajalahdewasa majalah3 = new hitungmajalahdewasa(jumlah);
               
               //menghitung hasil & konversi ke string
               String hasilmajalahdewasa = String.valueOf(majalah3.JumlahAnak());
               
               //menampilkan hasil di label
               judultransaksi.setText("Total Pembelian");
               hargasatuan.setText("Harga Satuan    Rp 26.900");
               tagoutputjumlah.setText("Jumlah" + inputjumlah.getText() + "pcs");
               totaltransaksi.setText("Total    " + hasilmajalahdewasa);
