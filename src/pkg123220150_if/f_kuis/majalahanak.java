...
import Perhitungan.hitungmajalahanak;
...
public class majalahanak extends JFrame implements ActionListener{
    JLabel judul = new JLabel("Halaman Pembelian");
    JLabel tagkategori = new JLabel("Kategori      Majalah Anak");
    JLabel tagharga = new JLabel   ("Harga         Rp 12.700 /pcs");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == tombolbeli){
           try {
               ...
               // membuat objek
               hitungmajalahanak majalah1 = new hitungmajalahanak(jumlah);
               
               //menghitung hasil & konversi ke string
               String hasilmajalahanak = String.valueOf(majalah1.JumlahAnak());
               
               //menampilkan hasil di label
               judultransaksi.setText("Total Pembelian");
               hargasatuan.setText("Harga Satuan    Rp 12.700");
               tagoutputjumlah.setText("Jumlah" + inputjumlah.getText() + "pcs");
               totaltransaksi.setText("Total    " + hasilmajalahanak);
